...
class astar():
    def __init__(self,grid_value_matrix,start_pos,goal_pos,manual_obstacles,interactive,**kwargs):
...
for i in range(1000):
    ...
    a = astar(grid_matrix,start_position,goal_position,False,False)
